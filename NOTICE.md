...
| GS1 DataBar physical variants | ISO/IEC 24724 and public GS1 material were consulted on 2026-08-13. The Omnidirectional/Truncated, Limited, Stacked and Stacked Omnidirectional encoders/decoders use original Sythos arithmetic and strict geometry checks. Independent implementations were used only as black-box verification; no third-party source code or table is copied or shipped. GS1 DataBar Expanded remains outside this release. |
