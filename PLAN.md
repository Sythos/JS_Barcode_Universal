...
The regression and false-positive corpus contains **288 passing tests**, including automatic global-threshold fallback coverage for large clean QR Code and PDF417 rasters. A local benchmark of
