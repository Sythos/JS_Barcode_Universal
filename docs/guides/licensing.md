...
| Codablock-F and Code 16K | The stacked Code 128 implementations are original Sythos work. Public format descriptions and the USS Code 16K reference inform the structural checks; independent implementations are black-box validation tools only, with no source or tables shipped. Patent, trademark and specification positions remain marked for legal review in the per-format inventories. |
| DotCode | The DotCode implementation is original Sythos work based on public format descriptions. Zint, ZXing and other independent software may be used only for black-box validation or review; no third-party source, table or runtime dependency is shipped. Patent, trademark and specification positions remain subject to legal review in `licenses/dotcode.license`. |
| Han Xin Code | The bounded Han Xin implementation is original Sythos work based on public format descriptions. Independent software is used only for black-box validation or review; no third-party source, table or runtime dependency is shipped. Version, patent, trademark and specification positions remain subject to legal review in `licenses/hanxin.license`. |
| GS1 DataBar Composite | The bounded `gs1composite` profile is original Sythos work based on public ISO/IEC 24723 and GS1 descriptions. Its linked DataBar host, MicroPDF417-derived component, marker and strict detector are not a complete certified composite implementation. Independent software is black-box validation only; no third-party source, table or runtime dependency is shipped. Patent, trademark and specification positions remain subject to legal review in `licenses/gs1-composite.license`. |
