...
| --- | --- | --- |
| Linear 1D | EAN/UPC, ISBN, Code 11, Code 39, Code 93, Code 128, ITF, ITF-14, Codabar, MSI, Telepen and Pharmacode | Writing and reading are separate capabilities. Pharmacode is intentionally write-only, while Telepen Numeric is an explicit mode. |
