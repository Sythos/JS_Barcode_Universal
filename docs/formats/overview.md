...
At this checkout the registry returns **53 entries**: all 53 are writable and
52 are readable. Pharmacode is intentionally the only `canRead: false` entry.
...
| --- | --- | :---: | :---: | :---: | --- |
| Linear 1D | `ean13`, `ean8`, `upca`, `upce`, `isbn`, `code128`, `gs1128`, `code39`, `code93`, `itf`, `itf14`, `standard2of5`, `industrial2of5`, `iata2of5`, `datalogic2of5`, `fim`, `codabar`, `code11`, `msi`, `code32`, `pzn`, `telepen`, `pharmacode` | Linear | 23 | 22 | Pharmacode is writer-only; Code 25 aliases, PZN variants, Data Logic's rejected 2:1 ratio, FIM's fixed five-pattern enum and Telepen Numeric are explicit modes/limits. |
