...
[`src/index.js`](../../src/index.js), with the TypeScript source and declarations
in [`src/ts/index.ts`](../../src/ts/index.ts) and
[`src/index.d.ts`](../../src/index.d.ts). If this page ever disagrees with the
...
engineering and provenance boundaries in [`NOTICE.md`](../../NOTICE.md), the
root [`LICENSE`](../../LICENSE), and the individual files in
[`licenses/`](../../licenses/).
...
is in [`NOTICE.md`](../../NOTICE.md); the remaining scope and deliberately
excluded formats are in [`PLAN.md`](../../PLAN.md).
