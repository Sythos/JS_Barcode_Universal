...
At this checkout the registry returns **52 entries**: all 52 are writable and
51 are readable. Pharmacode is intentionally the only `canRead: false` entry.
...
| --- | --- | :---: | :---: | :---: | --- |
| Linear 1D | `ean13`, `ean8`, `upca`, `upce`, `isbn`, `code128`, `gs1128`, `code39`, `code93`, `itf`, `itf14`, `standard2of5`, `industrial2of5`, `iata2of5`, `datalogic2of5`, `codabar`, `code11`, `msi`, `code32`, `pzn`, `telepen`, `pharmacode` | Linear | 22 | 21 | Pharmacode is writer-only; Code 25 aliases, PZN variants, Data Logic's rejected 2:1 ratio and Telepen Numeric are explicit modes/limits. |
