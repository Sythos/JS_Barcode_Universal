...
| `@sythos/js_barcode_universal/oned` | EAN/UPC, ISBN, Code 11/39/93/128, Code 25 variants, Code 32, PZN, ITF, Codabar, MSI, Telepen, POSTNET, PLANET, RM4SCC, KIX, Australia Post, Japan Post, IMb, Pharmacode and EAN add-ons. |
...
| `@sythos/js_barcode_universal/codablockf` | Codablock-F stacked Code 128 encoder, decoder and clean-raster detector. |
